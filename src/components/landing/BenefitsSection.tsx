      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-28 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            {/* Headline Premium */}
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-serif text-[#131842] leading-[1.08] tracking-[-0.02em] max-w-xl">
              {benefits.title}
              <br />
            ...
            >
              ...
              <p className="text-slate-600 font-sans text-base sm:text-lg lg:text-xl leading-relaxed pl-6 sm:pl-8 max-w-xl">
                Na Magrass, a sofisticação encontra o rigor científico. Unimos tecnologia de elite
                e métodos exclusivos para garantir que sua jornada seja{" "}
                <span className="text-[#131842] font-semibold">segura, luxuosa e transformadora.</span>
              </p>
            </motion.div>
            ...
            >
              {/* Glow Effect */}
              <div className="absolute -inset-0.5 bg-gradient-to-r from-[#C5A059] to-[#d4b068] rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-all duration-700" aria-hidden="true" />
          ...
          >
            {benefits.items.map((item, index) => (
              ...
              >
                ...
                <div className="absolute -inset-1 bg-gradient-to-r from-[#C5A059]/0 via-[#C5A059]/20 to-[#C5A059]/0 rounded-2xl opacity-0 group-hover:opacity-100 blur-xl transition-all duration-700" aria-hidden="true" />
